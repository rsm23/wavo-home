      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="max-w-3xl space-y-4">
          ...
          <h2 className="text-3xl sm:text-5xl font-black text-white tracking-tight leading-tight">
            ...
            <span className="wavo-gradient-text">sans dette ni avance</span> de trésorerie
          </h2>
          ...
          {pillars.map((pillar, idx) => {
            ...
            return (
              <FloatingCard3D key={pillar.id} className="h-full">
                <div className="h-full p-8 sm:p-10 rounded-3xl wavo-card flex flex-col justify-between group relative overflow-hidden space-y-8">
                  
                  {/* Subtle coral ambient gradient spotlight */}
                  <div className="absolute -top-32 -right-32 w-72 h-72 bg-gradient-to-br from-[#fa6e69]/15 via-[#ffbc7d]/10 to-transparent rounded-full blur-3xl opacity-40 group-hover:opacity-75 transition-opacity duration-500 pointer-events-none" />

                  <div className="space-y-6 relative z-10">
                    {/* Top Row: Icon & Tag */}
                    <div className="flex items-center justify-between">
                      <div className="p-3.5 rounded-2xl bg-white/[0.04] border border-white/[0.1] text-[#fa6e69] group-hover:scale-110 group-hover:text-[#ffbc7d] transition-all duration-300">
                  ...
                  <div className="pt-6 border-t border-white/[0.08] flex items-center justify-between relative z-10">
                    <span className="text-xs font-semibold text-[#fa6e69] group-hover:text-[#ffbc7d] flex items-center gap-1.5 transition-colors">
