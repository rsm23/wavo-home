...
export default function CorePillarsBento() {
  ...
  return (
    <section id="piliers" className="relative z-20 py-28 bg-[#080b13] border-t border-white/[0.08]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
        ...
        <div className="rounded-3xl bg-[#0f131f] border border-white/[0.09] shadow-2xl overflow-hidden">
          
          {/* Table Header Bar */}
          <div className="grid grid-cols-1 md:grid-cols-12 bg-black/50 border-b border-white/[0.08] text-xs font-mono uppercase tracking-wider text-slate-400 p-5 sm:px-8 items-center">
            <div className="md:col-span-4 font-bold text-slate-300">
              Paramètre Financier Clé
            </div>
            <div className="hidden md:block md:col-span-4 text-rose-400/80 font-bold">
          ...
          <div className="divide-y divide-white/[0.06]">
            {comparisonRows.map((row, idx) => (
              <div 
                key={idx} 
                className="grid grid-cols-1 md:grid-cols-12 p-6 sm:px-8 gap-4 sm:gap-6 items-center hover:bg-white/[0.015] transition-colors"
              >
                {/* Column 1: Criterion */}
                <div className="md:col-span-4 space-y-1">
                  <span className="px-2 py-0.5 rounded-md bg-white/[0.05] text-slate-400 text-[10px] font-mono block w-fit">
                    {row.badge}
                  </span>
                ...
                <div className="md:col-span-4 p-3.5 rounded-xl bg-rose-950/10 border border-rose-500/20 text-xs text-rose-200 space-y-1.5">
                  <div className="flex items-center gap-1.5 font-bold text-rose-400 text-[11px] font-mono">
                ...
                <div className="md:col-span-4 p-3.5 rounded-xl bg-[#fa6e69]/10 border border-[#fa6e69]/30 text-xs text-slate-200 space-y-1.5">
          ...
          <div className="p-6 sm:px-8 bg-black/60 border-t border-white/[0.08] flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono text-slate-400">
        ...
        <div className="space-y-8">
          ...
          <div className="flex items-center justify-between border-b border-white/[0.08] pb-4">
            ...
            <div className="text-xs font-mono text-[#fa6e69]">
              0{activeTab + 1} / 04
            </div>
          </div>
              ...
              return (
                <button
                  ...
                  className={`p-4 rounded-2xl border text-left transition-all cursor-pointer flex flex-col justify-between gap-4 ${
                    isSelected
                      ? "bg-[#fa6e69]/15 border-[#fa6e69] text-white shadow-xl shadow-[#fa6e69]/15"
                      : "bg-[#0f131f] border-white/[0.06] text-slate-400 hover:text-white hover:bg-white/[0.03]"
                  }`}
                >
                  <div className="flex items-center justify-between">
                    <div className={`p-2.5 rounded-xl ${isSelected ? "bg-[#fa6e69] text-white" : "bg-white/[0.04] text-slate-500"}`}>
          ...
          {(() => {
            ...
            return (
              <div className="p-8 sm:p-12 rounded-3xl bg-gradient-to-br from-[#0f131f] via-[#141926] to-[#080b13] border border-white/[0.1] shadow-2xl relative overflow-hidden grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                
                <div className="lg:col-span-7 space-y-6">
                  <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-[#fa6e69]/15 border border-[#fa6e69]/30 text-[#fa6e69] text-xs font-mono font-bold">
                  ...
                  <div className="space-y-3 pt-2">
                    {currentPillar.highlights.map((hl, hIdx) => (
                      <div key={hIdx} className="flex items-center gap-3 text-xs sm:text-sm text-slate-200 font-medium">
                        <div className="w-5 h-5 rounded-full bg-[#fa6e69]/20 border border-[#fa6e69]/40 flex items-center justify-center flex-shrink-0 text-[#fa6e69]">
                ...
                <div className="lg:col-span-5 space-y-4">
                  <div className="p-6 rounded-2xl bg-black/50 border border-white/[0.08] space-y-4">
                    ...
                    <div className="space-y-3 font-mono text-xs">
                      <div className="flex justify-between items-center py-2 border-b border-white/[0.06]">
                        <span className="text-slate-400">Valeur engagée :</span>
                        <span className="text-white font-bold">100% facture HT</span>
                      </div>
                      <div className="flex justify-between items-center py-2 border-b border-white/[0.06]">
                        <span className="text-slate-400">Avance de TVA :</span>
                        <span className="text-[#ffbc7d] font-bold">+20% pris en charge</span>
                      </div>
                      <div className="flex justify-between items-center py-2 border-b border-white/[0.06]">
                        <span className="text-slate-400">Impact Ratio D/E :</span>
                        <span className="text-emerald-400 font-bold">0.00x (Neutre)</span>
                      </div>
                      <div className="flex justify-between items-center py-2">
                        <span className="text-slate-400">Cotation Banque de France :</span>
                        <span className="text-emerald-400 font-bold">Protégée</span>
                      </div>
                    </div>
                  </div>

                  <div className="p-4 rounded-xl bg-white/[0.02] border border-white/[0.05] text-[11px] font-mono text-slate-400 flex items-center justify-between">
