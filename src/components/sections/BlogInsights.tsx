...
export default function BlogInsights() {
  ...
  return (
    <section id="blog" className="relative z-20 py-28 bg-[#07080d] border-t border-white/[0.08]">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6">
          <div className="max-w-2xl space-y-4">
            ...
            <h2 className="text-3xl sm:text-5xl font-black text-white tracking-tight">
              Nos derniers <span className="fintech-gradient-text">articles de blog</span>
            </h2>
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 text-xs font-bold text-cyan-400 hover:text-cyan-300 transition-colors self-start sm:self-auto font-mono"
          >
          ...
          {blogArticles.map((article, idx) => (
            <FloatingCard3D key={idx} className="h-full">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="h-full rounded-3xl fintech-card overflow-hidden flex flex-col justify-between group block"
              >
                <div>
                  <div className="relative h-52 w-full overflow-hidden bg-black/40">
                    ...
                    />
                    <div className="absolute top-3.5 left-3.5 px-3 py-1 rounded-xl bg-black/70 backdrop-blur-md text-[10px] font-mono font-bold uppercase tracking-wider text-cyan-300 border border-white/[0.1]">
                      {article.tag}
                    </div>
                  </div>
                ...
                <div className="p-7 pt-0 flex items-center justify-between text-xs font-bold text-indigo-400 group-hover:text-cyan-300 transition-colors">
